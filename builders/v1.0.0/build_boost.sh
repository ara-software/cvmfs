...
PACKAGE_NAME="boost"
DOWNLOAD_LINK="https://sourceforge.net/projects/boost/files/boost/1.49.0/boost_1_49_0.tar.gz"
PACKAGE_DIR_NAME="boost_1_49_0"
...
if [ $SKIP_BUILD = false ]; then
	...
	./bjam install #|| exit 32 # We'll allow some compilation errors here, evidently they don't cause issues
fi
